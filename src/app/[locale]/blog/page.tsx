...
const copy: Record<Locale, { title: string; description: string }> = {
  pt: { title: "Blog de engenharia de software", description: "Notas tecnicas sobre arquitetura, produtos digitais, IA e entrega de software." },
  en: { title: "Software engineering blog", description: "Technical notes on architecture, digital products, AI, and software delivery." },
  es: { title: "Blog de ingenieria de software", description: "Notas tecnicas sobre arquitectura, productos digitales, IA y entrega de software." },
}
